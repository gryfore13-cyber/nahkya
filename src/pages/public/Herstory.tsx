    ...
    <div className="min-h-screen bg-nahkya-ivory">
      <div className="bg-nahkya-charcoal py-24 px-5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="font-display text-display-lg text-nahkya-ivory font-medium mb-4">Herstory</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {herstoryArticles.map((a) => (
            <div key={a.id} className="group">
              <div className="aspect-16/10 bg-nahkya-stone rounded-nahkya overflow-hidden mb-5">
              ...
              <p className="text-body-md text-nahkya-text-muted font-body mb-4">{a.excerpt}</p>
