    ...
    <div className="min-h-screen relative flex items-center justify-center px-5 py-12">
      ...
      <div className="relative z-content w-full max-w-auth">
        ...
        <div className="text-center mb-10">
          <p className="font-mono text-mono-sm text-nahkya-highlight tracking-hero uppercase mb-3">Welcome Back</p>
          <h1 className="font-display text-4xl text-nahkya-text font-medium leading-tight mb-3">Sign in to the Atelier</h1>
          <p className="text-body-md text-nahkya-text-secondary font-body">Continue your creative journey</p>
        </div>
        ...
        <div className="bg-nahkya-text/60 backdrop-blur-xl border border-nahkya-highlight/10 rounded-nahkya p-8 lg:p-10">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-right">
              <Link to="/contact" className="text-body-xs text-nahkya-text-secondary hover:text-nahkya-highlight transition-colors font-body">Forgot password?</Link>
            </div>
        ...
        <p className="text-center text-sm text-nahkya-text-secondary font-body mt-8">
          New to the atelier? <Link to="/signup" className="text-nahkya-highlight hover:text-nahkya-border transition-colors font-medium">Create an account</Link>
        </p>
      </div>
    </div>
  );
