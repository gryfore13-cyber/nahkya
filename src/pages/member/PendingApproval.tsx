      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <div className="flex justify-center mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-nahkya-gold/10 border border-nahkya-gold/20 rounded-nahkya">
              <Clock className="w-4 h-4 text-nahkya-gold" strokeWidth={1.5} />
              <span className="font-mono text-mono-sm text-nahkya-gold uppercase tracking-wider">
                Pending Approval
              </span>
            </div>
          </div>
          ...
          <div className="bg-workspace-panel border border-workspace-border rounded-nahkya p-6 lg:p-8 mb-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center py-2 border-b border-workspace-border">
                <span className="text-sm text-nahkya-text-muted font-body">Account type</span>
              ...
              <div className="flex justify-between items-center py-2">
                ...
                <span className="text-sm text-nahkya-gold font-body">Under review</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            <p className="font-mono text-mono-sm text-nahkya-text-muted uppercase text-center mb-3">
              While you wait
            </p>
            <Link
              to="/"
              className={cn(
                'flex items-center gap-3 px-4 py-3 bg-workspace-panel border border-workspace-border',
                'rounded-nahkya text-nahkya-text hover:border-nahkya-gold/30 transition-colors'
              )}
            >
              <Home className="w-4 h-4 text-nahkya-gold" strokeWidth={1.5} />
            ...
            >
              <BookOpen className="w-4 h-4 text-nahkya-gold" strokeWidth={1.5} />
            ...
            >
              <User className="w-4 h-4 text-nahkya-gold" strokeWidth={1.5} />
